...
export class BlogController {
  ...
  @authenticate({strategy: 'jwt', options: {required: [PermissionKeys.BlogManagement]}})
  @post('/blogs', {
    responses: {
      '200': {
  ...
  @authenticate({strategy: 'jwt', options: {required: [PermissionKeys.GetBlogs, PermissionKeys.BlogManagement]}})
  @get('/blogs', {
    responses: {
      '200': {
